...
class _$_User implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, fullName: $fullName, email: $email, password: $password, walletAmount: $walletAmount)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, fullName, email, password, walletAmount);
...
abstract class _User implements User {
  const factory _User(
      ...
      required final String walletAmount}) = _$_User;
