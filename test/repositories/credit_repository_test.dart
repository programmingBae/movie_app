...
import 'package:movie_app/entities/credit.dart';
...
void main() {
  test("Get Movie Credits", () {
    Dio dio = MockDio();
    String url =
        "https://api.themoviedb.org/3/movie/550/credits?api_key=e8fe9f9fff4de0d37b0e69fa6df8cd5c";
    when(dio.get(url)).thenAnswer((_) async {
      ...
      }, statusCode: 200, requestOptions: RequestOptions(path: url)));

      List<Credit> creditsResult =
          await MovieRepository(dio: dio).getCredits(550);

      expect(creditsResult.first.name, equals("Edward Norton"));
    });
  });
}
